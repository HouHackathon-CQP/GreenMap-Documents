...
1. **Tiếp nhận báo cáo** - Maintainers sẽ xác nhận đã nhận báo cáo trong vòng 48 giờ
2. **Điều tra** - Team sẽ xem xét chi tiết vụ việc, thu thập thông tin từ các bên liên quan
3. **Quyết định** - Team sẽ đưa ra quyết định về hành động cần thực hiện
4. **Thực thi** - Áp dụng các biện pháp phù hợp
5. **Theo dõi** - Đảm bảo vi phạm không tái diễn
...
**Cảnh cáo:**
- Cảnh cáo bằng văn bản về vi phạm
- Yêu cầu xin lỗi công khai hoặc riêng tư

**Tạm thời cấm:**
- Tạm thời cấm tham gia vào dự án trong một khoảng thời gian nhất định
- Không được tương tác với cộng đồng, bao gồm tương tác với những người thực thi Quy Tắc Ứng Xử

**Vĩnh viễn cấm:**
- Vĩnh viễn cấm tham gia vào dự án
- Xóa tất cả các đóng góp (nếu có thể)
...
2. **Implement changes** với clear commit messages
3. **Add tests** nếu thêm tính năng mới
4. **Update documentation** nếu thay đổi APIs
5. **Ensure CI passes** trước khi request review
6. **Link related issues** trong PR description
7. **Be responsive** với reviewer comments
...
**GitHub:**
- Issues - Báo bugs, đề xuất features
...
1. Đọc documentation thoroughly
2. Search existing issues/discussions
3. Reproduce và document lỗi rõ ràng
...
**Contributor:**
- Đã có ít nhất 1 merged PR

**Active Contributor:**
- 5+ merged PRs
- Regular participation trong discussions

**Core Contributor:**
- 20+ merged PRs
- Maintain một phần của codebase
- Help với code reviews

**Maintainer:**
- Full repository access
- Quyết định về roadmap
...
Quy Tắc Ứng Xử này được điều chỉnh từ [Contributor Covenant](https://www.contributor-covenant.org), version 2.1, có sẵn tại https://www.contributor-covenant.org/version/2/1/code_of_conduct.html.
