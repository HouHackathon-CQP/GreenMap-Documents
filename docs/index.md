...
<div class="features">
  ...
  <div class="feature">
    <h3>💻 Web Portal</h3>
    <p><strong>React 19 + Vite 7.2 + Tailwind</strong> - Admin dashboard với bản đồ realtime, quản lý báo cáo & hạ tầng.</p>
    <ul class="feature-list">
      <li><strong>React 19</strong> - Latest React features & hooks</li>
  ...
  <div class="feature">
    ...
    <ul class="feature-list">
      ...
      <li><strong>MapLibre SDK</strong> - Open-source offline maps</li>
...
<div class="tech-grid">
  ...
  <div class="tech-card">
    <h4>⚛️ Frontend</h4>
    <p><strong>React 19</strong> · Vite 7.2 · Tailwind CSS · MapLibre GL · Recharts</p>
  </div>
  <div class="tech-card">
    <h4>🤖 Mobile</h4>
